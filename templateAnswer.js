let answers = {
    'Hello !': {
        type: 'message',
        answer: 'Bonjour Bonjour ! Nous sommes Catherine et Liliane. En quoi pouvons nous vous être utile ?'
    },
    TUTO_YES_OFFRES: {
        type: 'web_url',
        ...
        message: 'Chic, chic, regardez cette page. Je pense que vous allez trouver votre bonheur !'
    },
    TUTO_YES_SITE: {
        type: 'web_url',
